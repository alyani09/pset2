...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header" style="height:50%">
      ...
      <img src="logo\logo1.jpg" width="100" height="60">
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="mainpage.php?email=<?php echo $email. '&name='.$name?>">List</a></li>
        <li><a href="add.php?email=<?php echo $email. '&name='.$name?>">New Performance</a></li>
        <li><a href="profile.php?email=<?php echo $email. '&name='.$name?>">Profile</a></li>
        <!-- <li><a href="blog.php?email=<?php echo $email. '&name='.$name?>">Post</a></li> -->
